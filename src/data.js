const products = [
	{
		...
		box: [
			{ type: "Speaker Unit", unit: "2X" },
			{ type: "Speaker cloth panel", unit: "2X" },
			{ type: "User manual", unit: "1X" },
			{ type: "3.5mm 10m audio cable ", unit: "1X" },
			{ type: "10m optical cable", unit: "1X" },
		],
		images: [
			"https://res.cloudinary.com/drphqvmfe/image/upload/v1682447040/audiophile-asset/zx7-ii_fy5in8.jpg",
			"https://res.cloudinary.com/drphqvmfe/image/upload/v1682447039/audiophile-asset/zx7-i_pnch8u.jpg",
		],
		price: 299.99,
		available: 20,
	},
	{
		...
		box: [
			{ type: "Headphone Unit", unit: "1X" },
			{ type: "Replacement earcups", unit: "2X" },
			{ type: "User manual", unit: "1X" },
			{ type: "3.5mm 5m audio cable ", unit: "1X" },
			{ type: "Travel bag", unit: "1X" },
		],
		images: [
			"https://res.cloudinary.com/drphqvmfe/image/upload/v1682447040/audiophile-asset/zx7-ii_fy5in8.jpg",
			"https://res.cloudinary.com/drphqvmfe/image/upload/v1682447039/audiophile-asset/zx7-i_pnch8u.jpg",
	...
	},
	{
		...
		box: [
			{ type: "Earphone Unit", unit: "2X" },
			{ type: "Multi-size earplugs", unit: "6X" },
			{ type: "User manual", unit: "1X" },
			{ type: "USB-C charging cable ", unit: "1X" },
			{ type: "Travel pouch", unit: "1X" },
		],
		images: [
			"https://res.cloudinary.com/drphqvmfe/image/upload/v1682447040/audiophile-asset/zx7-ii_fy5in8.jpg",
			"https://res.cloudinary.com/drphqvmfe/image/upload/v1682447039/audiophile-asset/zx7-i_pnch8u.jpg",
	...
	},
	{
		...
		box: [
			...
			{ type: "Speaker cloth panel", unit: "2X" },
			{ type: "User manual", unit: "1X" },
			{ type: "3.5mm 7.5 audio cable ", unit: "1X" },
			{ type: "7.5m optical cable", unit: "1X" },
		],
		images: [
			"https://res.cloudinary.com/drphqvmfe/image/upload/v1682447040/audiophile-asset/zx7-ii_fy5in8.jpg",
			"https://res.cloudinary.com/drphqvmfe/image/upload/v1682447039/audiophile-asset/zx7-i_pnch8u.jpg",
